...
You will learn how Ethereum works, but also why it is designed the way it is. You will be able to understand not only how each of the pieces work, but also how they fit together and why.
